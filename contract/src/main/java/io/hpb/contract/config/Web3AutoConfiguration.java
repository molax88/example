...
@EnableConfigurationProperties(io.hpb.contract.config.Web3Properties.class)
public class Web3AutoConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(prefix = Web3Properties.WEB3_PREFIX, name = "admin-client", havingValue = "true")
    public Admin admin() {
        Web3Service Web3Service = buildService(properties.getClientAddress());
