...
public class PaginationPlugin  extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("com.mapper.BaseDao");
     ...
     * Dao中添加方法
     */
    public Method generateDeleteLogicByIds(Method method, IntrospectedTable introspectedTable) {
     ...
     * 实体中添加属性
     */
    public void addLimit(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String name) {
        CommentGenerator commentGenerator = context.getCommentGenerator();
        Field field = new Field();
    ...
    public static void generate() {
        String config = PaginationPlugin.class.getClassLoader().getResource("generator/generatorConfig.xml").getFile();
