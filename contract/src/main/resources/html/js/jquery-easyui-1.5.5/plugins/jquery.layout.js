...
(function($) {
	...
	function _19(_1a, _1b, el) {
		...
		var _1d = $.extend({}, $.fn.layout.paneldefaults, {
			...
			onOpen : function() {
				...
				if (!t.length) {
					t = $("<a href=\"javascript:;\"></a>").addClass(_20)
							.appendTo(_1e);
					t.bind("click", {
						dir : dir
					}, function(e) {
								...
								{},
								{
									...
									onStartResize : function(e) {
										...
										if (dir == "north") {
											...
											if (dir == "south") {
												pos.top = parseInt(_22
														.css("top"));
												pos.left = parseInt(_22
														.css("left"));
												pos.width = _22.outerWidth();
												pos.height = _23.height();
											} else {
		...
		function _28(p) {
			var _2c = "expand" + dir.substring(0, 1).toUpperCase()
					+ dir.substring(1);
			var _2d = _1c["center"];
			var _2e = (dir == "north" || dir == "south") ? "minHeight"
					: "minWidth";
			var _2f = (dir == "north" || dir == "south") ? "maxHeight"
					: "maxWidth";
			var _30 = (dir == "north" || dir == "south") ? "_outerHeight"
					: "_outerWidth";
			var _31 = $.parser.parseValue(_2f, _1c[dir].panel("options")[_2f],
					$(_1a));
			var _32 = $.parser.parseValue(_2e, _2d.panel("options")[_2e],
					$(_1a));
	...
	function _34(_35, _36) {
		...
		if (_37[_36].length) {
			...
			_37[_36] = $();
			var _38 = "expand" + _36.substring(0, 1).toUpperCase()
					+ _36.substring(1);
			if (_37[_38]) {
	...
	function _39(_3a, _3b, _3c) {
		...
		var _3f = "expand" + _3b.substring(0, 1).toUpperCase()
				+ _3b.substring(1);
		if (!_3d[_3f]) {
			_3d[_3f] = _40(_3b);
		...
		function _40(dir) {
			...
			p.panel($.extend({}, $.fn.layout.paneldefaults, {
				...
				onResize : function() {
					...
					if (_47.length) {
						...
						var _48 = ($(this).width() - Math.min(
								_47._outerWidth(), _47._outerHeight())) / 2;
						var top = Math.max(_47._outerWidth(), _47
								._outerHeight());
						if (_47.hasClass("layout-expand-title-down")) {
							_48 += Math.min(_47._outerWidth(), _47
									._outerHeight());
							top = 0;
						}
						_47.css({
			...
			if (!_3e.hideCollapsedContent) {
				var _49 = typeof _3e.collapsedContent == "function" ? _3e.collapsedContent
						.call(p[0], _3e.title)
						: _3e.collapsedContent;
				...
				if (_3b == "west") {
					...
					if (_3b == "north") {
						...
						if (!_a(_3d.expandNorth)) {
							hh += _4e - _4b
									+ ((_3e.split || !_3e.border) ? 1 : 0);
						}
						_3d.east.add(_3d.west).add(_3d.expandEast).add(
								_3d.expandWest).panel("resize", {
							top : _4b - 1,
							height : hh
						});
						return {
	...
	function _4f(_50, _51) {
		...
		var _54 = "expand" + _51.substring(0, 1).toUpperCase()
				+ _51.substring(1);
		if (_52[_54]) {
			_52[_54].panel("close");
	...
	$.fn.layout = function(_65, _66) {
		...
		return this.each(function() {
			...
			if (_67) {
				...
				var _68 = $.extend({}, $.fn.layout.defaults, $.fn.layout
						.parseOptions(this), _65);
				$.data(this, "layout", {
					options : _68,
					panels : {
						center : $(),
		...
		add : function(jq, _6d) {
			return jq
					.each(function() {
						_19(this, _6d);
						_2(this);
						if ($(this).layout("panel", _6d.region)
	...
	$.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults,
			{
				...
				collapsedContent : function(_77) {
					...
					var cc = [];
					if (_78.iconCls) {
						cc.push("<div class=\"panel-icon " + _78.iconCls
								+ "\"></div>");
					}
