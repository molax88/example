...
(function($) {
	...
	function _3(_4, _5) {
		...
		if (!isNaN(parseInt(_7.height))) {
			if (_c) {
				...
				_a._outerWidth(_8.width() - _11 - _b._outerWidth())
						._outerHeight(_13);
				_b._outerHeight(_13);
				_a.css({
					left : "",
			...
			_a.css("height", "");
			var min = $.parser.parseValue("minHeight", _7.minHeight, _8
					.parent());
			var max = $.parser.parseValue("maxHeight", _7.maxHeight, _8
					.parent());
			var _14 = _9._outerHeight() + _b._outerHeight() + _8._outerHeight()
					- _8.height();
	...
	function _1f(_20) {
		...
		_23.removeClass("panel-hleft panel-hright").addClass(
				"panel-h" + _22.halign);
		_24();
		_25();
		...
		function _24() {
			if (_22.noheader || (!_22.title && !_22.header)) {
				...
				if (_22.header) {
					...
					if (!_29.length) {
						_29 = $("<div class=\"panel-header\"></div>")
								.prependTo(_23);
					}
					if (!$.isArray(_22.tools)) {
						_29.find("div.panel-tool .panel-tool-a").appendTo(
								_22.tools);
					}
					_29.empty();
					var _2a = $("<div class=\"panel-title\"></div>").html(
							_22.title).appendTo(_29);
					if (_22.iconCls) {
						_2a.addClass("panel-with-icon");
						$("<div class=\"panel-icon\"></div>").addClass(
								_22.iconCls).appendTo(_29);
					}
					if (_22.halign == "left" || _22.halign == "right") {
						_2a.addClass("panel-title-" + _22.titleDirection);
					}
					var _2b = $("<div class=\"panel-tool\"></div>").appendTo(
							_29);
				...
				_23.children("div.panel-body").removeClass(
						"panel-body-noheader");
			}
		}
		;
		function _2c(c, _2d, _2e) {
			var a = $("<a href=\"javascript:;\"></a>").addClass(_2d)
					.appendTo(c);
			a.bind("click", _2e);
		}
		;
	...
	function _3b(_3c, _3d) {
		...
		function cb() {
			_3f.closed = false;
			_3f.minimized = false;
			var _41 = _40.children(".panel-header")
	...
	function _43(_50, _51) {
		...
		if (_51 == true) {
			if (_52.halign == "left" || _52.halign == "right") {
				_53.animate({
					width : _55._outerWidth()
							+ _53.children(".panel-footer")._outerWidth()
				}, function() {
					cb();
				});
			} else {
			...
			if (_52.halign == "left" || _52.halign == "right") {
				_53._outerWidth(_55._outerWidth()
						+ _53.children(".panel-footer")._outerWidth());
			}
			cb();
		}
	...
	$.fn.panel = function(_70, _71) {
		...
		return this.each(function() {
			...
			if (_72) {
				...
				_73 = $.extend({}, $.fn.panel.defaults, $.fn.panel
						.parseOptions(this), _70);
				$(this).attr("title", "");
				_72 = $.data(this, "panel", {
					options : _73,
					panel : _1b(this),
	...
	$.fn.panel.parseOptions = function(_84) {
		...
		return $.extend({}, $.parser.parseOptions(_84, [ "id", "width",
