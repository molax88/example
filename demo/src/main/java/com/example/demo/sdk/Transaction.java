...
//    private static String keyStore = "D:/backup/hpb/keystore/UTC--2018-10-20T10-59-58.572322860Z--1b40e7c67f4ea6acc16bca4b27e22c9512ad1d60";
    ...
    private Logger log = Logger.getLogger("Transaction");
...
//        String hpbNodeIp="http://222.128.104.75:30100";
    ...
    public HpbSendTransaction createNewTrade(String toAccountId, String passsword, String money) throws Exception {
...
//            ECKeyPair.create()
            HpbBlock hpbBlock = Transaction.getHpbBlockByNumber(new BigInteger("817599"));
